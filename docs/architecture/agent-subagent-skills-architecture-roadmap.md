...
ShuaiTravelAgent 当前已经有一个可运行的 LangGraph Agent，但如果要从“单个能回答问题的 Agent”升级成“能支撑复杂旅行决策产品的 Agent 系统”，下一阶段应该怎么演进。
...
- [chat_service.py](/D:/projects/shuai/ShuaiTravelAgent/web/shuai_web/services/chat_service.py)
- [builder.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/builder.py)
- [state.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/state.py)
- [nodes.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/nodes.py)
- [travel_tools.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/tools/travel_tools.py)
- [memory_integration.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/memory_integration.py)
- [persistent_checkpointer.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/persistent_checkpointer.py)
...
[nodes.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/nodes.py) 当前同时承担了：
...
[travel_tools.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/tools/travel_tools.py) 当前更像 `tool adapters + mock fallback + provider bridge`，但还不是 skill 层。
...
[builder.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/builder.py) 里的图虽然已经有分支和回环，但本质还是单一主 Agent 图。
...
[state.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/state.py) 里的 `AgentState` 已经包含很多字段，这本身没有问题，但继续无节制增长会带来：
...
当前 [nodes.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/nodes.py) 里的 `verify_node` 和 `self_check_node` 已经体现出质量闭环思想，但它们还没有真正成为“独立 evaluator”。
...
[memory_integration.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/memory_integration.py) 已经很好，但当前 memory 主要面向整个 session。
...
这一层当前已经有雏形，主要就在 [travel_tools.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/tools/travel_tools.py) 和相关 provider 适配里。
...
| 当前文件 | 问题 | 未来建议落点 |
| --- | --- | --- |
| [graph/builder.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/builder.py) | 当前承担全部主图装配 | 保留为兼容层，新增 `supervisor/graph_builder.py` |
| [graph/nodes.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/nodes.py) | 过大、职责过多 | 拆到 `supervisor/` + `subagents/` |
| [graph/state.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/state.py) | 单大状态对象 | 新增 `supervisor_state.py`、artifact state |
| [tools/travel_tools.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/tools/travel_tools.py) | tools 与 skill 未分层 | 保留 tool adapter，新增 `skills/registry.py` |
| [graph/memory_integration.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/memory_integration.py) | memory 主要面向整轮 session | 迁移到 `memory/`，拆 conversation / working / artifact memory |
| [graph/persistent_checkpointer.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/persistent_checkpointer.py) | 能力可保留 | 继续复用，提供 runtime-level 接口 |
| [chat_service.py](/D:/projects/shuai/ShuaiTravelAgent/web/shuai_web/services/chat_service.py) | 直接耦合 graph 细节 | 改为调 `agent_runtime.py` |
...
- 对前端现有 SSE 协议保持兼容
- [chat_service.py](/D:/projects/shuai/ShuaiTravelAgent/web/shuai_web/services/chat_service.py) 不再直接依赖底层 graph 细节
...
- `web/shuai_web/routes/artifact.py`
- `web/shuai_web/services/artifact_service.py`
...
- [api.ts](/D:/projects/shuai/ShuaiTravelAgent/frontend/src/services/api.ts)
- [ChatArea.tsx](/D:/projects/shuai/ShuaiTravelAgent/frontend/src/components/ChatArea.tsx)
- [TravelPlanToolkit.tsx](/D:/projects/shuai/ShuaiTravelAgent/frontend/src/components/TravelPlanToolkit.tsx)
...
- [system-architecture.md](/D:/projects/shuai/ShuaiTravelAgent/docs/architecture/system-architecture.md)
- [api-reference.md](/D:/projects/shuai/ShuaiTravelAgent/docs/reference/api-reference.md)
- [testing-guide.md](/D:/projects/shuai/ShuaiTravelAgent/docs/testing/testing-guide.md)
- [project-structure.md](/D:/projects/shuai/ShuaiTravelAgent/docs/reference/project-structure.md)

### Phase 2

- [system-architecture.md](/D:/projects/shuai/ShuaiTravelAgent/docs/architecture/system-architecture.md)
- [api-reference.md](/D:/projects/shuai/ShuaiTravelAgent/docs/reference/api-reference.md)
- [04-agent-core-tools-memory-checkpoint.md](/D:/projects/shuai/ShuaiTravelAgent/docs/teaching/04-agent-core-tools-memory-checkpoint.md)
- [testing-guide.md](/D:/projects/shuai/ShuaiTravelAgent/docs/testing/testing-guide.md)

### Phase 3

- [system-architecture.md](/D:/projects/shuai/ShuaiTravelAgent/docs/architecture/system-architecture.md)
- [product-requirements.md](/D:/projects/shuai/ShuaiTravelAgent/docs/product/product-requirements.md)
- [api-reference.md](/D:/projects/shuai/ShuaiTravelAgent/docs/reference/api-reference.md)
- [02-chat-mainline-and-frontend.md](/D:/projects/shuai/ShuaiTravelAgent/docs/teaching/02-chat-mainline-and-frontend.md)
...
2. 把 [nodes.py](/D:/projects/shuai/ShuaiTravelAgent/agent/travel_agent/graph/nodes.py) 拆成 supervisor / subagent 可迁移结构
3. 在当前 tools 之上加 `skills registry`
4. 把 `verify/self_check` 升级成独立 verification subagent

## 15. 一句话结论

ShuaiTravelAgent 的下一阶段，不应该再继续把单个主 Agent 做得越来越重，而应该把它升级成：
